...
bool CNetworkSock::ChangeUserCard( sUserCardChange *psUserCardChange )
{
	DTRACE("CNetworkSock::ChangeUserCard");
	...
	WriteSendQue( GAMESENDMODE, (char)NGCS_CARDCHANGE, (char)ERROR_NOT, (char *)psUserCardChange, sizeof(sUserCardChange));					
	if ( !Send() ) return false;
...
bool CNetworkSock::ChangeUserCardEnd()
{
	DTRACE("CNetworkSock::ChangeUserCardEnd");
	...
	WriteSendQue( GAMESENDMODE, (char)NGCS_CARDCHANGEEND, (char)ERROR_NOT, NULL, 0);					
	if ( !Send() ) return false;
